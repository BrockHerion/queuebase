...
- **Free**: This plan is free to use and includes 100 jobs runs per day and a 1,000 job runs per month. It's a great option for small projects with a limited number of jobs and a team with less experience. You are only allowed to have one team on this plan at a time. This plan is also the default plan for new teams.
- **Pro**: This plan includes unlimited runs per day and a limit of 100,000 jobs runs per month. If you go over the limit, you'll be charged an additional $10 per 100,000 jobs runs. It's a good option for larger projects with a large number of jobs and a team with more experience. You are also able to add additional team members.
